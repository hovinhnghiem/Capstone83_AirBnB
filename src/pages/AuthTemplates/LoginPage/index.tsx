  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-red-100 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-br from-pink-200 to-red-200 rounded-full opacity-10 blur-2xl"></div>
      </div>
        ...
        <Card className="backdrop-blur-lg bg-white/80 border-0 shadow-2xl rounded-3xl overflow-hidden">
          ...
          <CardContent className="px-8 pb-8">
            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
              ...
              >
                <Link to="/auth/register" className="flex items-center justify-center space-x-2">
